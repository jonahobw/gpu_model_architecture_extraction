"""Creates an executable based on model_inference.py for your OS.

This scipt provides functionality to create a standalone executable from model_inference.py
